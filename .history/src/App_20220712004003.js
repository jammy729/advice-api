...
const App = () => {
  ...
  25% { transform: scale(1) rotate(90deg); border-radius: 40%; }
  50% { transform: scale(1) rotate(180deg); border-radius: 500%; }
  25% { transform: scale(1) rotate(90deg); border-radius: 20%; }
